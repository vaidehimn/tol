...
if (isset($_POST["submit"]))
{
    ...
    mysqli_query($con, "INSERT INTO `tbl_room`(`room_name`, `room_image`, `room_amount`,`room_status`) 
	...
	<body>
		...
		<section id="content">
			...
			<main>
				<table>
            	    <div class="container">
					  <h2 style="color: #9f8e64;">ADD ROOM</h2>
  						<form method="POST" action="#" onsubmit="return validate();" enctype="multipart/form-data"> 
  							<label>Room Name:</label>
	    					<input type="text" id="name" name="name" placeholder="Add Room name">
					...
					<div class="order">
						...
						<table>
							...
							<tbody>
								...
								?>
								<tr>
									<td><p><?php echo $res['room_name'];?></p></td>
									<td><img src="images/<?php echo $res['room_image'];?>" width="50px" height="50px"></td>
									<td><p><?php echo $res['room_amount'];?></p></td> 						
									<td><a href="editroom.php?edit_id=<?php echo $res['room_id']; ?>"><span style="background-color:rgb(62, 191, 214);" class="status completed">EDIT</span></a>
									</td>
									<td><?php echo $res['room_status'];?></td>
								<td><a href="inactiveroom.php?aaa=<?php echo $res['room_id'];?>"><input type="button" value="Inactive">
  								<a href="activeroom.php?bbb=<?php echo $res['room_id'];?>"><input type="button" value="active"></td>
								</tr>
								<?php
								}
								?>
