...
{    
	...
	{  
        ...
        {
            $sql3="SELECT * FROM `tbl_usertype` WHERE `type_name`='Staff'";
...
<body>
    ...
    <section id="content">
        ...
        <main>
            <table>
                <div class="container">
                    <h2 style="color: #9f8e64;">ADD STAFF</h2><br>
...
function validate() {
    if (document.getElementById('name').value.length == 0 || document.getElementById('email').value.length == 0 ||
        document.getElementById('phone').value.length == 0 || document.getElementById('cpassword').value.length == 0) {
...
email.onkeyup = function() {
    ...
    if (regex.test(email.value) || regexo.test(email.value)) {
        ...
        span[11].innerText = "your email is invalid";
...
phn.onkeyup = function() {
    ...
    if (regexn.test(phn.value)) {
        ...
        span[12].innerText = "your number is invalid";
